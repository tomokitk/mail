       ...
       <div class="col-lg">
        <form class="form-inline" action="{{('/search')}}" >
          ...
          <div class="form-group">
            ...
            @if(isset($keyword))
              <input type="text" name="name" value="{{$keyword}}" placeholder="氏名">
            @else
              <input type="text" name="name" value="" placeholder="氏名">
            @endif
            ...
            @if(isset($keyword3))
                <input type="text" name="department" value="{{$keyword3}}" placeholder="部署名">
            @else
              <input type="text" name="department" value="" placeholder="部署名">
            @endif
